<script lang="ts">
	...
	import FiltersTagsTab from "../tabs/tabTags.svelte";
	import FiltersPropsTab from "../tabs/tabProps.svelte";
	import FiltersFilesTab from "../tabs/tabFiles.svelte";
	import SortPopup from "../popups/popupSort.svelte";
	import ViewModePopup from "../popups/popupView.svelte";
