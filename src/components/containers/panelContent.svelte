...
<div class="vm-ops-section">
  ...
  {#if contentRegexError}
    <div class="vm-content-regex-error">
      {contentRegexError}
    </div>
  {/if}
  <input
  ...
  />
  <div class="vm-content-scope-hint">
    {contentScopeHint}
  </div>
  <div class="vm-content-actions">
    <button
      class="vm-btn"
  ...
  {#if contentPreviewResult !== null}
    <div class="vm-content-preview">
      <div
        class="vm-content-preview-header"
        onclick={() => {
        ...
        tabindex="0"
      >
        <span class="vm-preview-chevron">{contentPreviewOpen ? "▼" : "▶"}</span
        >
