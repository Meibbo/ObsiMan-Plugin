...
- [ ] #effort/Research si es mejor convertirlo en un plugin particular, un producto aparte. O si es mejor adherir los ideales a otro proyecto
  - me parecía buena idea anexarlo de alguna forma a notebook navigator , pero abarca tantos aspectos y tiene una filosofía tan distinta que me parece lo correcto hacerlo un plugin aparte
- [ ] #effort/Ask if there’s any competition to your idea, that might be already available for public consumption
