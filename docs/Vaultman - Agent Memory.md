...
- **BRAT**: Para que el plugin sea detectable y actualizable por BRAT, se debe crear un **GitHub Release** oficial para el tag (sin "v") y adjuntar `main.js`, `manifest.json` y `styles.css` como **assets**. BRAT no lee los archivos directamente del repo para las actualizaciones, sino de los assets del release.
