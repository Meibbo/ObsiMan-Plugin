...
- Source of truth: `docs/work/pkm-ai/specs/2026-05-04-orchestration-refresh/`.
- Richer V2 draft: `docs/work/pkm-ai/specs/2026-05-04-orchestration-refresh-v2/`.
- V2 plan draft: `docs/work/pkm-ai/plans/2026-05-04-orchestration-refresh-v2/`.
- Bootstrap, migration, backlog, tools, and initial `vm-*` skills are implemented.
- `tools/pkm-ai/update-frontmatter.mjs` is implemented and tested.
...
- Current item: [[docs/work/pkm-ai/items/vm-0001-pkm-ai-orchestration-refresh|VM-0001]] in `verify`.
...
- Wave A A0/A1 completed; A1 follow-up repaired prop rename queue ingestion:
  [[docs/work/hardening/plans/2026-05-06-cmenu-queue-repair/index|CMenu queue repair]],
  [[docs/work/hardening/plans/2026-05-06-prop-value-rename-handoff/index|prop value rename handoff]].
...
- `health_passed` for `docs`, detail `0 warnings`, recorded in
  `metrics/pkm-ai.jsonl`.
...
- Latest run: focused `serviceFnR`/`serviceQueue`/`explorerTags`/`explorerFiles`
  unit tests, focused `pageFiltersRenameHandoff` component test,
