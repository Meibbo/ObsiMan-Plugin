...
AI files include `AGENTS.md`, `CLAUDE.md`, `.agents/`, `.claude/`, caches, and
agent-only generated docs.

## Docs Boundary

- `.agents/docs`: agent working memory, policies, specs, plans, items, archive.
- `.agents/skills`: project-owned skills and approved local skill copies.
- `.agents/tools`: deterministic scripts for agent workflow.
