...
**Files:**
- Create folder: `.agents/tools/pkm-ai/`
- Create: `.agents/tools/pkm-ai/package.json`
...
**Files:**
- Create: `.agents/tools/pkm-ai/check-doc-health.mjs`
...
**Files:**
- Create: `.agents/tools/pkm-ai/index-docs.mjs`
- Create: `.agents/tools/pkm-ai/query-docs.mjs`
- Create: `.agents/tools/pkm-ai/update-indexes.mjs`

- [ ] Parse frontmatter structurally.
- [ ] Output compact route summaries.
- [ ] Keep cache rebuildable under `.agents/cache/`.

## Task 4: Add Sharding Helper

**Files:**
- Create: `.agents/tools/pkm-ai/shard-index.mjs`
