...
- Completed in wave A:
  A0 CMenu queue repair, A1 prop/value rename handoff, and A2 tag/file rename
  handoff with prop queue ingestion follow-up.
- Next slice: A3 navbar badges and quick actions.
- Remaining after A3: deeper Obsidian/Bases/Dataview parser compatibility.
...
- Combined component runs can still hit the known transient `svelte` resolver
  issue; avoid running Vite/Svelte verification commands in parallel.
